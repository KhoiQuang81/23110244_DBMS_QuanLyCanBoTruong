...
exec sp_helprolemember 'r_TruongKhoa';
...
VALUES (N'Test', 'test@ute.edu.vn', '09090909', 2); 

INSERT INTO TaiKhoan(UserId, Username, Password)
VALUES (11, N'truongkhoatest', N'246');
...
EXEC HasP_GetLopChuaPhanCong N'PRTE230385';
...
EXEC HasP_GetSoTietByMon N'PRTE230385';
...
EXEC dbo.HasP_InsertPhanCong
    @MaLopHocPhan = N'INPR140285_02',
    @MaCB = N'2003',
    @MaMon = N'INPR140285',
    @SoTiet = 75,
    @SoTuan = 15,
	...
	EXEC dbo.HasP_UpdatePhanCong
    @OldMaCB = N'2003',
    @OldMaMon = N'INPR140285',
    @OldMaLopHocPhan = N'INPR140285_02',
    @OldHocKy = 1,
    @OldNamHoc = N'2025-2026',
    @NewMaMon = N'PRTE230385',
    @NewMaLopHocPhan = N'PRTE230385_26',
    @NewSoTiet = 50,
    @NewSoTuan = 16,
    @NewHocKy = 1,
    @NewNamHoc = N'2025-2026',
    @NewMaNganh = N'7480201';


	EXEC dbo.HasP_DeletePhanCong
    @MaLopHocPhan = N'PRTE230385_26',
    @MaCB = N'2003',
    @HocKy = 1,
    @NamHoc = N'2025-2026',
    @MaMon = N'PRTE230385';
